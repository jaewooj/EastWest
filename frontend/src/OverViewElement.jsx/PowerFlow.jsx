...
const PowerFlow = () => {
    ...
    useEffect(() => {
       ...
       // 첫 번째 path에서 시작하여 두 번째 path까지 이동하는 애니메이션
        ...
        /* const circle03 = svg.append("circle")
        .attr("cx", 275) // 시작 x 좌표
        .attr("cy", 70) // 시작 y 좌표
        .attr("r", 4) // 원의 반지름
        .style("fill", "red") // 색상
        .style("opacity", 0); // 처음에는 원을 숨김

        const transitionPath03 = () => {
            circle03.style("opacity",1)
            .transition()
            .duration(8500) // 애니메이션 지속 시간 (5초)
            .ease(d3.easeLinear)
            .attr("cx", 386) // 끝 x 좌표
            .attr("cy", 70) // 끝 y 좌표
            .transition()
            .duration(0) // 애니메이션 지속 시간 (5초)
            .ease(d3.easeLinear)
            .attr("cx", 275) // 끝 x 좌표 (시작점으로 되돌아감)
            .attr("cy", 70) // 끝 y 좌표 (시작점으로 되돌아감)
            .on("end", transitionPath03); // 애니메이션 끝나면 다시 시작
        };
        setTimeout(()=>{
          transitionPath03();
        },8500); */
            ...
            <svg height="380" viewBox="-50 10 800 380" width="800">
                <svg width="50" viewBox="0 1200 512 512" xmlns="http://www.w3.org/2000/svg">
                    <path d="M505.629,444.763l-17.847-263.486c-0.252-3.762-3.379-6.681-7.146-6.681H56.49c-3.771,0-6.898,2.919-7.15,6.681
                        ...
                        c1.25,0,2.249,1.008,2.249,2.252v12.941c0,1.242-0.999,2.25-2.249,2.25c-1.237,0-2.255-1.008-2.255-2.25V15.184z" fill="#000000"/>
                </svg>
                <path d="M26 100 L26 120" stroke="black" strokeWidth="2" />
                ...
                <path d="M126 100 L126 120" stroke="black" strokeWidth="2" />
                <path d="M26 120 L226 120" stroke="black" strokeWidth="2" />
                <path d="M226 120 L226 90" stroke="black" strokeWidth="2" />
                <path d="M226 90 L256 90" stroke="black" strokeWidth="2" />
                ...
                <path d="M295 90 L406 90" stroke="black" strokeWidth="2" />
