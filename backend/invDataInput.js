...
const invDataInput = async () =>{
    ...
    try {
        ...
        await connection.execute(updateInv01DataInputQuery,[invData[0],invData[1],invData[2],invData[3],invData[4],invData[5],invData[6],invData[7],invData[8],invData[9],dateTime])
