...
const invDataInput = async () =>{
    ...
    try {
        ...
        const updateInv01DataInputQuery = `
            UPDATE ${tableName} 
            SET R001 = ?, R002 = ?, R003 = ?, R004 = ?, R005 = ?, R006 = ?, R060 = ?
            WHERE date_time = ?
        `
        ...
        await connection.execute(updateInv01DataInputQuery,[invData[0],invData[1],invData[2],invData[3],invData[4],invData[5],invData[6],dateTime])
